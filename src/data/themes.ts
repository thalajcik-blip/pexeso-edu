...
export const THEMES: Record<Theme, ThemeColors> = {
  ...
  light: {
    ...
    accent:             '#ac79f5',
    accentGradient:     'linear-gradient(135deg, #ac79f5 0%, #ef8cfa 100%)',
    accentText:         '#ffffff',
    accentGlow:         'rgba(172,121,245,0.25)',
    accentBorderActive: 'rgba(172,121,245,0.7)',
    accentBgActive:     'rgba(172,121,245,0.1)',
  },
}
