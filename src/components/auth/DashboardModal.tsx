...
export default function DashboardModal() {
  ...
  return (
    ...
    >
      <div
        className="w-full max-w-md rounded-lg flex flex-col max-h-[90vh]"
        ...
        <div className="overflow-y-auto px-6 pb-6 space-y-5">
          ...
          <div className="grid grid-cols-4 gap-2">
            {[
              ...
              <div key={label} className="rounded-lg p-2.5 text-center" style={{ background: tc.btnInactiveBg, border: `1px solid ${tc.btnInactiveBorder}` }}>
              ...
              <div className="space-y-2">
                ...
                {visibleGames.length < games.length && (
                  <button
                    ...
                    className="w-full py-2 text-sm rounded-lg border transition-opacity hover:opacity-80"
